...
def load(filePath):
    # 读取数据
    data_csv = pd.read_csv(filePath, usecols=[3])
    # 去除读入的数据中含有NaN的行。
...
def power_price(filePath, saveFilePath):
    # 初始化Q值表
...
if __name__ == "__main__":
    q_table = power_price('./new_data_nong_lstm_24_01_07.csv','./new_data_nong_lstm_24_01_07.csv')
